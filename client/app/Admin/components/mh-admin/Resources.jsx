...
// Named export to match AdminDashboardLayout import
		...
		<div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
			<div className="mb-8 text-center">
				...
				<p className="text-gray-600">
					Share mental health resources with your patients
				</p>
			</div>
			...
			<form
				...
				{message && (
					<div
						className={`mt-4 p-4 rounded-xl text-sm ${message.includes("success") ? "bg-green-50 text-green-700" : "bg-red-50 text-red-700"}`}>
						{message}
					</div>
				)}
			</form>
