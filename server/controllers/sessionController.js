// Sessions controller: create/update sessions and handle payments.
// Comments are kept simple to explain each step.
...
export const requestSession = async (req, res) => {
	const { attendee_email, professional_email, session_type, session_date } =
		req.body;
...
export const completeSession = async (req, res) => {
	...
	try {
		...
		res
			.status(200)
			.json({ message: "Session marked as completed successfully!" });
	} catch (err) {
